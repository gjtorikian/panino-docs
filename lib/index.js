...
function Panino(files, options) {
    ...
    files.forEach(function (file) {
        ...
        try {
            ...
            if (options.additionalGlobalObjs) {
                try {
                    additionalGlobalObjsJSON = JSON.parse(fs.readFileSync(options.additionalGlobalObjs));
                }
                catch (e) {
                    console.error("Trouble parsing " + options.additionalGlobalObjs + "! I'm not adding these...");
                }
            }
    ...
    function link(text, classes, short) {
        ...
        if (!obj.resultingFile) { // might be global
            ...
            if (!obj.resultingFile) {
                if (additionalGlobalObjsJSON !== undefined) {
                    var url = additionalGlobalObjsJSON[text];
                    if (url === undefined) {
