...
function createBasicTranslation(memberName, type, i) {
  ...
  i = exclude(i, "name", "tagname", "doc", "description", "linenr", "private", "see");

  // whatever craziness is left, just jam it in -- as long as it's defined !
  return _.extend(node, _.filter(i, function(value) { value === undefined}));
}
