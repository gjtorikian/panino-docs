...
var nodeJSON = JSON.parse(fs.readFileSync(__dirname + "/../apf.json", 'UTF-8'));
var builtins = JSON.parse(fs.readFileSync(__dirname + "/../builtin.json", 'UTF-8'));
var URL_PREFIX = "http://developer.c9.io/apf/api/";
var GUID_PREFIX = "APF:";
...
fs.writeFileSync(__dirname + "/../builtin.apf.json", JSON.stringify(allResults, null, 2), "UTF-8");
