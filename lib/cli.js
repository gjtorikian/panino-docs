...
panino.main = exports.main = function (args, callback) {
    ...
    default:
        ...
        help: 'Defines the type of language you are documenting. Only necessary with Markdown files; otherwise, file extensions are used. See README for details on usage.',
        metavar: 'STRING',
    default:
        'NADA',
    }).option('docPath', {
        ...
        case 'html':
            ...
            if (opts.split == 'yes') {
                paninoArray.forEach(function (n) {
                    var html = n.toHTML(opts, jsonDocs.list);
