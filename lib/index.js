...
function Panino(files, options) {
    ...
    files.forEach(function (file) {
        ...
        try {
            ...
            if (options.additionalGlobalObjs !== undefined) {
                try {
            ...
            // these seem complicated to set up...
...
Panino.prototype.toHTML = function (options, fullList, outFile) {
    ...
    function link(text, classes, short) {
        ...
        // we're creating a link to the exact file we're in...
    ...
    function argumentTable(args, tableClasses, trClasses, tdClasses) {
        ...
        for (var a in args) {
            ...
            r += '<td class="arg' + requiredText + '" ' + (tdClasses || []).join(' ') + '">' + requiredText + '</td>';
