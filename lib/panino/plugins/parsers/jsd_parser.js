...
var process_jsd = function(source, file, options, callback) {
  ...
  remainingNodes = _.reject(remainingNodes, function(i) {
    ...
    if (i["tagname"] === "method" || isEvent) {
      nodes[memberName] = createBasicTranslation(memberName, isEvent ? "event": "method", i, options);
      ...
      nodes[memberName]["signatures"].push({"arguments": nodes[memberName]["arguments"], "returns": [ret]});
