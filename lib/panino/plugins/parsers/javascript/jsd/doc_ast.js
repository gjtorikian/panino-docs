...
DocAst.prototype = {
   detect: function(tagname, docs) {
      switch (tagname) {
        ...
        case "attribute":
          return create_attribute(docs);
        case "binding":
          return create_binding(docs);
        case "cfg":
...
function create_class(docs) {
    ...
    return add_shared({
      ...
      "define" : extract(doc_map, "define"),
      "enum" : detect_enum(doc_map),
      "override" : extract(doc_map, "override", "class"),
      "allowchild" : extract(doc_map, "allowchild"),
      "baseclass" : extract(doc_map, "baseclass") !== null ? true : false
    }, doc_map);
}
...
function create_attribute(docs) {
    var doc_map = build_doc_map(docs);
    return add_shared({
      "tagname" : "attribute",
...
function detect_doc(docs) {
    var ignore_tags = ["param", "return", "author", "version", "cancelable", "bubbles", "since"];
