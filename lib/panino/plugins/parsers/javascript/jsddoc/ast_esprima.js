...
function isExtDefine(ast) {
  return isCall(ast) && ext_define_patterns.include(to_s(ast["callee"]));
}
...
function make_mixins(cfg_value) {
  ...
  var classes = v.constructor === Object ? _.values(v) : Array(v);
