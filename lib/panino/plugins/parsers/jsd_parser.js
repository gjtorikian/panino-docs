...
var process_jsd = function(source, file, options, callback) {
  var nodes = {}, remainingNodes, ast, docs, expanded, merged, classPrefix, list = {}, functions = [], extractedFunctions = [], tree, parted, sections, children;
  doc_ast = new DocAst();
  ...
  if (options.splitByClass) {
    ...
    while (merged.length > 0) {
      ...
      // by making sure the linenr is within this class
